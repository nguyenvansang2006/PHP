...
$_SESSION['msg'].= "Dữ liệu không đúng cấu trúc, Dữ liệu upload bị lỗi Hoặc chưa chọn file upl
oad<br>";
else{
 // Đã có dữ liệu upload, thực hiện xử lý file upload
 //Thư mục bạn sẽ lưu file upload
 $target_dir = "public/upload/";
 //Vị trí file lưu trong server (file sẽ lưu trong uploads, với tên giống tên ban đầu)
